    ...
    <div className="flex h-screen overflow-hidden bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900">
      ...
      <div className="flex flex-col flex-1 h-full">
        ...
        <div className="p-5 border-b border-white/10 flex-shrink-0">
          ...
          <p className="text-slate-300 mt-1 text-sm">Communicate with your property owner</p>
        </div>
        ...
        <div className="flex-1 flex flex-col overflow-hidden">
          ...
          {/* Chat Messages */}
          <div className="flex-1 overflow-y-auto p-4 bg-white/5 min-h-0">
            {loading ? (
              ...
              <div className="space-y-4">
                {messages.map((message) => {
                    ...
                    return (
                      ...
                      >
                        <div
                          className={`max-w-xs sm:max-w-md rounded-xl px-4 py-2 text-sm ${bubbleStyle}`}
                        >
