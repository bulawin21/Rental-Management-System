...
export default function TenantMessages() {
  ...
  return (
    <div className="grid gap-6">
      {/* Header */}
      <header>
        <h1 className="text-3xl font-semibold text-[#0b4a81]">Messages</h1>
        <p className="text-slate-600 mt-2">Communicate with your property manager.</p>
      </header>

      {/* Messages Layout */}
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 h-125">
        {/* Chat Panel */}
        <div className="lg:col-span-3 rounded-lg bg-white shadow-sm border border-gray-100 flex flex-col">
          {/* Chat Header */}
          <div className="p-4 border-b border-gray-200">
            <div>
              <div className="font-medium text-slate-900">Property Manager</div>
              <div className="text-xs text-slate-500">Messages will appear here from your property manager</div>
            </div>
          </div>
            ...
            {loading ? (
              ...
              <div className="space-y-4">
                {messages.map((message) => {
                    ...
                    const bubbleStyle = isOwnMessage ? 'bg-blue-500 text-white' : 'bg-gray-200 text-slate-900';
                    ...
                    return (
                      ...
                      >
                        <div
                          className={`max-w-xs rounded-lg px-4 py-2 text-sm ${bubbleStyle}`}
                        >
          ...
          <div className="p-4 border-t border-gray-200">
            ...
            <div className="flex gap-2">
              ...
              <button 
                ...
                className="rounded-md bg-[#0b4a81] px-4 py-2.5 text-white text-sm hover:bg-[#0a3a35] disabled:opacity-50 disabled:cursor-not-allowed"
              >
                Send
              </button>
            </div>
