  ...
  return (
    <div className="min-h-screen bg-gray-50 grid place-items-center">
      <div className="w-full max-w-md bg-white rounded-xl p-8 shadow-md">
        <h1 className="text-2xl font-semibold text-[#0b4a81]">Tenant Login</h1>
        <p className="text-sm text-slate-600 mt-2">Sign in to your tenant account.</p>
        ...
        <form onSubmit={handleSignIn} className="mt-6 space-y-4">
          ...
          <div className="flex items-center justify-between">
            <button
              type="submit"
              disabled={loading}
              className="inline-block rounded-md bg-[#0b4a81] px-4 py-2 text-white disabled:opacity-50"
            >
